...
import com.kotokhabi.domain.OrderItem;
import com.kotokhabi.domain.MenuItem;
import com.kotokhabi.storage.StorageRepository;
import io.javalin.http.Context;
import java.util.Map;
import java.util.UUID;

public class CartFlowController {
    private final StorageRepository repository;

    public CartFlowController(StorageRepository repository) {
    ...
    public void placeOrder(Context ctx) {
        com.kotokhabi.domain.User user = ctx.sessionAttribute("user");
