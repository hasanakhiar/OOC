...
public class XmlRepository implements StorageRepository {
    private final String dataDir = "storage-data/";

    public XmlRepository() {
        new File(dataDir).mkdirs(); // Ensure "storage-data/" directory exists
    }
    ...
    public void saveRestaurant(Restaurant restaurant) {
        // We save each restaurant in its own file: storage-data/koto_khabi_restaurant_ID.xml
        saveToFile(restaurant, "koto_khabi_restaurant_" + restaurant.getId() + ".xml");
    }
    ...
    public List<Restaurant> getAllRestaurants() {
        ...
        File[] files = folder.listFiles((dir, name) -> name.startsWith("koto_khabi_restaurant_") && name.endsWith(".xml"));
    ...
    public Restaurant getRestaurantById(String id) {
        try {
            File file = new File(dataDir + "koto_khabi_restaurant_" + id + ".xml");
